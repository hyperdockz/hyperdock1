...
██   ██    ██    ██      ███████ ██   ██ ██████   ██████   ██████ ██   ██ 
         ...
         Made By Deniz. issi :3     Make Sure You Did idx tool setup
========================================================================
EOF
    echo
}
...
declare -A OS_OPTIONS=(
    ...
    ["Fedora 40"]="fedora|40|https://dl.fedoraproject.org/pub/fedora/linux/releases/40/Cloud/x86_64/images/Fedora-Cloud-Base-40-1.14.x86_64.qcow2|fedora40|fedora|fedora"
