...
██   ██    ██    ██      ███████ ██   ██ ██████   ██████   ██████ ██   ██ 
  ...
  Made By Deniz. issi :3 Please Make Sure You Did The idx tool set up
========================================================================
EOF
    echo
}
...
declare -A OS_OPTIONS=(
    ...
    ["Fedora 40"]="fedora|40|https://download-ib01.fedoraproject.org/pub/fedora/linux/releases/42/Cloud/x86_64/images/Fedora-Cloud-Base-Generic-42-1.1.x86_64.qcow2|fedora40|fedora|fedora"
